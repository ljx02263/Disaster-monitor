...
\paperw11900\paperh16840\margl1440\margr1440\vieww27000\viewh18420\viewkind0
\deftab720
...
\
**To learn more about Prettier\'92s stance on options \'96 see the [Option Philosophy](option-philosophy.md).**\
\
If you change any options, it\'92s recommended to do it via a [configuration file](configuration.md). This way the Prettier CLI, [editor integrations](editors.md) and other tooling knows what options you use.\
\
## Print Width\
\
...
>\
> In code styleguides, maximum line length rules are often set to 100 or 120. However, when humans write code, they don\'92t strive to reach the maximum number of columns on every line. Developers often use whitespace to break up long lines for readability. In practice, the average line length often ends up well below the maximum.\
>\
> Prettier\'92s printWidth option does not work the same way. It is not the hard upper allowed line length limit. It is a way to say to Prettier roughly how long you\'92d like lines to be. Prettier will make both shorter and longer lines, but generally strive to meet the specified printWidth.\
>\
...
>\
> In other words, don\'92t try to use printWidth as if it was ESLint\'92s [max-len](https://eslint.org/docs/rules/max-len) \'96 they\'92re not the same. max-len just says what the maximum allowed line length is, but not what the generally preferred length is \'96 which is what printWidth specifies.\
\
| Default | CLI Override          | API Override        |\
| ------- | --------------------- | ------------------- |\
| `80`    | `--print-width <int>` | `printWidth: <int>` |\
\
(If you don\'92t want line wrapping when formatting Markdown, you can set the [Prose Wrap](#prose-wrap) option to disable it.)\
\
## Tab Width\
\
...
Notes:\
\
- JSX quotes ignore this option \'96 see [jsx-single-quote](#jsx-quotes).\
